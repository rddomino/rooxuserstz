...
const Spinner = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{margin: '0 auto', background: 'none', display: 'block', alignItems:'center'}} width="100px" height="100px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
